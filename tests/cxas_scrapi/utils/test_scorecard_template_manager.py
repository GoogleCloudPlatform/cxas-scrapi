...
class TestScorecardTemplateManager:
    def test_save_and_load_template(self, tmp_path: typing.Any) -> None:
    ...
    def test_save_clears_output_only_fields(self, tmp_path: typing.Any) -> None:
    ...
    def test_json_format(self, tmp_path: typing.Any) -> None:
    ...
    def test_json5_format(self, tmp_path: typing.Any) -> None:
    ...
    def test_yaml_format(self, tmp_path: typing.Any, ext: typing.Any) -> None:
    ...
    def test_json5_loading_with_comments(self, tmp_path: typing.Any) -> None:
    ...
    def test_invalid_extension(self, tmp_path: typing.Any) -> None:
